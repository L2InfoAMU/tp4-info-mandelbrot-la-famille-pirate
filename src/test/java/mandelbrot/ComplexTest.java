...
public class ComplexTest {
    ...
    void testReal() {
        ...
        assertNotEquals(new Complex(real, 1), Complex.real(real));
    }

    @Test
    void testAdd() {
        assertEquals(new Complex(3, 0), Complex.ONE.add(two));
    ...
    void testMultiply() {
        ...
        Complex z2 = new Complex(6, -5);
        assertEquals(new Complex(2, 2), onePlusI.multiply(two));
        assertEquals(new Complex(27, 8), z1.multiply(z2));
    ...
    void testSquaredModulus() {
        Complex c1 = new Complex(real, imaginary);
        assertEquals(c1.squaredModulus(), (real * real) + (imaginary * imaginary));
    }

    @Test
    void testModulus() {
        Complex c1 = new Complex(real, imaginary);
        assertEquals(c1.modulus(), Math.sqrt((real * real) + (imaginary * imaginary)));
